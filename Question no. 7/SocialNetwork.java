...
public class SocialNetwork {
    ...
    static class GraphPanel extends JPanel {
        ...
        public GraphPanel() {
            ...
            loadGraphData("abhidatafile.txt");
            ...
            try (BufferedReader br = new BufferedReader(new FileReader(fileName))) {
                ...
                while ((line = br.readLine()) != null) {
                    ...
                    if (parts.length == 2) {
                        ...
                        // Node sourceNode = idToNodeMap.getOrDefault(sourceId,
                        // createNewNode(sourceId));

                        // Node targetNode = idToNodeMap.getOrDefault(targetId,
                        // createNewNode(targetId));
